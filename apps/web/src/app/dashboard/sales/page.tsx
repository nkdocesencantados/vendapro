  ...
  return (
    ...
    <div style={{padding:"clamp(12px,3vw,28px)",maxWidth:1440,margin:"0 auto"}}>
      ...
      <style>{`
        ...
        .kpi .val{font-size:clamp(20px,2.5vw,32px);font-weight:700;} .kpi .lbl{font-size:clamp(11px,1vw,14px);} .kpi-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:10px;margin-bottom:16px;}
        ...
        @media(max-width:900px){.kpi .val{font-size:clamp(20px,2.5vw,32px);font-weight:700;} .kpi .lbl{font-size:clamp(11px,1vw,14px);} .kpi-grid{grid-template-columns:repeat(2,1fr);}}

        @media(max-width:640px){

          .kpi .val{font-size:clamp(20px,2.5vw,32px);font-weight:700;} .kpi .lbl{font-size:clamp(11px,1vw,14px);} .kpi-grid{grid-template-columns:1fr 1fr!important;}
