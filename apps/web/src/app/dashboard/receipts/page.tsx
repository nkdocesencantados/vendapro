  ...
  return (
    <div style={{padding:"clamp(12px,3vw,28px)",maxWidth:1440,margin:"0 auto"}}>
      <style>{`
        ...
        .receipt-paper{font-family:Arial,sans-serif;background:white;border-radius:12px;overflow:hidden;font-size:12px;line-height:1.7;width:100%;box-shadow:0 4px 24px rgba(0,0,0,0.15);} .receipt-header{background:#0C1A14;padding:18px 20px;display:flex;align-items:center;justify-content:space-between;} .rh-logo{width:36px;height:36px;border-radius:9px;background:#1D9E75;display:flex;align-items:center;justify-content:center;font-size:12px;font-weight:700;color:white;flex-shrink:0;} .rh-store{font-size:13px;font-weight:700;color:white;} .rh-sub{font-size:10px;color:#5A8C72;margin-top:2px;} .rh-num-label{font-size:10px;color:#5A8C72;text-align:right;} .rh-num-val{font-size:12px;color:#9FE1CB;font-weight:600;margin-top:2px;text-align:right;} .receipt-body{padding:16px 20px;} .rr{display:flex;justify-content:space-between;gap:8px;padding:6px 0;border-bottom:1px solid #F0F0F0;font-size:12px;color:#333;} .rr:last-child{border:none;} .rr span:first-child{color:#888;} .rdiv{border:0;border-top:1px dashed #E5EDE9;margin:12px 0;} .r-section{font-size:10px;font-weight:700;color:#888;text-transform:uppercase;letter-spacing:.07em;margin-bottom:8px;} .r-item{display:flex;justify-content:space-between;padding:4px 0;font-size:12px;color:#333;} .receipt-total{background:#F8FAF9;padding:12px 20px;display:flex;justify-content:space-between;align-items:center;} .receipt-total-label{font-size:14px;font-weight:700;color:#1a1a1a;} .receipt-total-val{font-size:22px;font-weight:700;color:#1D9E75;} .receipt-footer{padding:14px 20px;text-align:center;background:#0C1A14;} .receipt-footer .rf-thanks{font-size:12px;color:#9FE1CB;margin-bottom:3px;} .receipt-footer .rf-brand{font-size:10px;color:#5A8C72;} .pay-badge{background:#E1F5EE;color:#0F6E56;font-size:10px;padding:2px 8px;border-radius:99px;font-weight:600;}
