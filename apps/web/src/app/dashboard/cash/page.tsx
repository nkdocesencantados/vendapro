...
function exportCashPDF(entries: any[], income: number, expense: number, profit: number, month: number, year: number) {
  ...
  const kpis='<div style="display:grid;grid-template-columns:repeat(3,1fr);background:#F8FAF9;border-bottom:2px solid #E5EDE9;"><div style="padding:16px 20px;border-right:1px solid #E5EDE9;"><div style="font-size:10px;color:#888;text-transform:uppercase;margin-bottom:6px;">Entradas</div><div style="font-size:22px;font-weight:700;color:#1D9E75;">R$ '+income.toFixed(2)+'</div></div><div style="padding:16px 20px;border-right:1px solid #E5EDE9;"><div style="font-size:10px;color:#888;text-transform:uppercase;margin-bottom:6px;">Saidas</div><div style="font-size:22px;font-weight:700;color:#ef4444;">R$ '+expense.toFixed(2)+'</div></div><div style="padding:16px 20px;"><div style="font-size:10px;color:#888;text-transform:uppercase;margin-bottom:6px;">Saldo</div><div style="font-size:22px;font-weight:700;">R$ '+profit.toFixed(2)+'</div></div></div>';
  ...
  return (
    ...
    <div style={{padding:"clamp(12px,3vw,28px)",maxWidth:1440,margin:"0 auto"}}>
      ...
      <style>{`
        ...
        .month-sel{display:flex;gap:8px;margin-bottom:16px;align-items:center;} .month-sel .vp-select{background:var(--surface-2);border:1px solid var(--border);border-radius:var(--r);padding:9px 14px;font-size:13px;color:var(--text);outline:none;cursor:pointer;}
