...
function exportRepPDF(products: any[], revenue: number, profit: number, totalSales: number, from: string, to: string) {
  ...
  const prodRows=products.map((p:any,i:number)=>{const pct=maxRev>0?Math.round((Number(p.revenue)/maxRev)*100):0;const bar='<div style=flex:1;height:5px;background:#E5EDE9;border-radius:999px;overflow:hidden;margin:0 8px><div style=height:5px;background:#1D9E75;border-radius:999px;width:'+pct+'%></div></div>';return '<tr style=background:'+(i%2===0?'white':'#F8FAF9')+'><td style=padding:10px 14px;color:#888;font-size:11px>'+(i+1)+'</td><td style=padding:10px 14px;font-weight:500>'+p.name+'</td><td style=padding:10px 14px;text-align:center>'+p.quantity+'</td><td style=padding:10px 14px;text-align:right;font-weight:600>R$ '+Number(p.revenue).toFixed(2)+'</td><td style=padding:10px 14px;text-align:right;font-weight:600;color:#1D9E75>R$ '+(Number(p.revenue)*0.263).toFixed(2)+'</td><td style=padding:10px 14px><div style=display:flex;align-items:center>'+bar+'<span style=font-size:11px;color:#888;width:30px;text-align:right>'+pct+'%</span></div></td></tr>';}).join('');
  const svg='<svg width=22 height=22 viewBox=0 0 24 24 fill=none><circle cx=12 cy=4 r=2.5 fill=white/><circle cx=4 cy=18 r=2.5 fill=white/><circle cx=20 cy=18 r=2.5 fill=white/><line x1=12 y1=4 x2=4 y2=18 stroke=white stroke-width=1.5/><line x1=12 y1=4 x2=20 y2=18 stroke=white stroke-width=1.5/><line x1=4 y1=18 x2=20 y2=18 stroke=white stroke-width=1.5/></svg>';
  const html='<html><head><title>Relatorio VendaPro</title><style>*{box-sizing:border-box;margin:0;padding:0;}body{font-family:Arial,sans-serif;color:#1a1a1a;}</style></head><body><div style=background:#04130F;padding:24px 32px;display:flex;align-items:center;justify-content:space-between><div style=display:flex;align-items:center;gap:12px><div style=width:40px;height:40px;background:#1D9E75;border-radius:10px;display:flex;align-items:center;justify-content:center>'+svg+'</div><div><div style=font-size:16px;font-weight:700;color:white>VendaPro</div><div style=font-size:11px;color:#6B8C82;margin-top:2px>N&K Doces Encantados</div></div></div><div style=text-align:right><div style=font-size:18px;font-weight:700;color:white>Relatorio de Desempenho</div><div style=font-size:12px;color:#8DA39A;margin-top:3px>Periodo: '+from+' a '+to+'</div><div style=font-size:11px;color:#6B8C82;margin-top:2px>Gerado em '+new Date().toLocaleString('pt-BR')+'</div></div></div><div style=display:grid;grid-template-columns:repeat(4,1fr);background:#F8FAF9;border-bottom:1px solid #E5EDE9><div style=padding:16px 20px;border-right:1px solid #E5EDE9><div style=font-size:10px;color:#888;text-transform:uppercase;letter-spacing:.05em;margin-bottom:4px>Faturamento</div><div style=font-size:22px;font-weight:700;color:#1D9E75>R$ '+revenue.toFixed(2)+'</div></div><div style=padding:16px 20px;border-right:1px solid #E5EDE9><div style=font-size:10px;color:#888;text-transform:uppercase;letter-spacing:.05em;margin-bottom:4px>Lucro estimado</div><div style=font-size:22px;font-weight:700>R$ '+profit.toFixed(2)+'</div></div><div style=padding:16px 20px;border-right:1px solid #E5EDE9><div style=font-size:10px;color:#888;text-transform:uppercase;letter-spacing:.05em;margin-bottom:4px>Margem</div><div style=font-size:22px;font-weight:700>'+margin+'%</div></div><div style=padding:16px 20px><div style=font-size:10px;color:#888;text-transform:uppercase;letter-spacing:.05em;margin-bottom:4px>Total vendas</div><div style=font-size:22px;font-weight:700>'+totalSales+'</div></div></div><div style=padding:20px 32px><div style=font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.06em;color:#888;margin-bottom:14px>Top Produtos</div><table style=width:100%;border-collapse:collapse;font-size:13px><thead><tr style=background:#1D9E75><th style=color:white;padding:10px 14px;text-align:left;font-size:11px;font-weight:600>Rank</th><th style=color:white;padding:10px 14px;text-align:left;font-size:11px;font-weight:600>Produto</th><th style=color:white;padding:10px 14px;text-align:center;font-size:11px;font-weight:600>Qtd</th><th style=color:white;padding:10px 14px;text-align:right;font-size:11px;font-weight:600>Receita</th><th style=color:white;padding:10px 14px;text-align:right;font-size:11px;font-weight:600>Lucro</th><th style=color:white;padding:10px 14px;font-size:11px;font-weight:600>Participacao</th></tr></thead><tbody>'+prodRows+'</tbody></table></div><div style=padding:14px 32px;background:#F8FAF9;display:flex;align-items:center;justify-content:space-between;border-top:1px solid #E5EDE9><div style=font-size:11px;color:#888>VendaPro - vendapro.com.br</div><div style=font-size:11px;color:#1D9E75;font-weight:600>N&K Doces Encantados</div></div></body></html>';
  vpPDF(html);
}
