...
export default function LoginPage() {
  ...
  return (
    <div style={{ minHeight:"100vh", display:"flex", fontFamily:"DM Sans, sans-serif" }}>
      <div style={{ width:"50%", background:"#04342C", display:"flex", flexDirection:"column", justifyContent:"space-between", padding:"64px", color:"white" }}>
        <div style={{ display:"flex", alignItems:"center", gap:"12px" }}>
          <div style={{ width:"40px", height:"40px", background:"#1D9E75", borderRadius:"10px", display:"flex", alignItems:"center", justifyContent:"center", fontSize:"20px" }}>??</div>
      ...
      <div style={{ flex:1, display:"flex", alignItems:"center", justifyContent:"center", background:"#f5f4f0", padding:"32px" }}>
        <div style={{ width:"100%", maxWidth:"400px" }}>
          <h2 style={{ fontSize:"26px", fontWeight:500, marginBottom:"8px", color:"#111" }}>Entrar na sua conta</h2>
          <p style={{ color:"#888", fontSize:"14px", marginBottom:"32px" }}>Informe suas credenciais para continuar.</p>
